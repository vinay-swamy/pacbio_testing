...
def model_results(obj, Y_pred_class, Y_pred_prob, data_name, outdir):
...
class Experiment:
    ...
    def run_model(self, obj_name, model_name):
        ...
        trained_model, y_pred_class, y_pred_prob=model(obj)
        model_res_line = model_results(obj, y_pred_class, y_pred_prob, f'{obj_name}_{model_name}', self.outdir)
